...
public class ServerSend
{
    ...
    public static void SpawnEnemy(Enemy_Server _enemy)
    {
    ...
    public static void SpawnEnemy(int _toClient, Enemy_Server _enemy)
    {
        using (Packet _packet = new Packet((int)ServerPackets.spawnEnemy))
        {
    ...
    private static Packet SpawnEnemy_Data(Enemy_Server _enemy, Packet _packet)
    {
    ...
    public static void EnemyPosition(Enemy_Server _enemy)
    {
    ...
    public static void EnemyHealth(Enemy_Server _enemy)
    {
